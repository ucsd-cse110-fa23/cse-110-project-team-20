...
public class MS1UserStoryTest extends UserStoryTestBase {
    @Test
    public void
    scenario_1_2_listDoesNotHaveRecipeThatTheUserWants()
    {
        /**
    ...
    @Test
    public void
    scenario_2_1_mealTypeIsSelected()
    {
        /**
    ...
    @Test
    public void
    scenario_2_2_recipeIsGenerated()
    {
        /**
    ...
    @Test
    public void
    scenario_2_3_saveButtionIsClicked()
    {
        /**
         * Scenario 2.3: Save Button Is Clicked
         * Given the recipe has been generated
         * When the “save” button is pressed
         * Then the recipe list of recipes window becomes active and the generated recipe is at the
         * top
         */
    ...
    @Test
    public void
    scenario_2_4_cancelButtionIsClicked()
    {
        /**
    ...
    @Test
    public void
    scenario_3_1_userViewsAnExistingRecipe()
    {
        /**
    ...
    @Test
    public void
    scenario_5_1_userDeletesARecipe()
    {
        /**
         ...
         *    And the list no longer contains the recipe, with all other recipes appropriately
         * shifted
         */
    ...
    {
        recipeModel.recipes.add(
            new Recipe("Chicken with potato", "Chicken with potato recipe instruction."));
        recipeModel.recipes.add(new Recipe("Chicken with broccoli",
            "Chicken with broccoli recipe instruction. Boil for 50 mins."));
        recipeModel.recipes.add(
            new Recipe("Chicken with cabbage", "Chicken with cabbage recipe instruction."));
    }
    ...
    @Test
    public void
    scenario_4_1_userPressesTheEditButton()
    {
        /**
    ...
    @Test
    public void
    scenario_4_3_userPressesTheSaveButton()
    {
    ...
    @Test
    public void
    sceenario_4_4_userPressesTheBackButton()
    {

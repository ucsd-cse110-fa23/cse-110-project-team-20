 ...
 *
 * It allows whatever accounts the user typed in for testing purpose. It does not check any
...
public class LocalAccountService implements IAccountService {
    ...
    {
        System.out.println(
            String.format("[Login] login/create account with %s. It always passes the login.",
                username, password));
        return true;
    }
}

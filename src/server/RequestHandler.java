...
public class RequestHandler implements HttpHandler {
    // private List<Recipe> recipes; // currently, data is not written to permanent storage
    ...
    // TODO: This is a stub with very basic functionality, should be developed when we decide on a
    // format
    private String
    handleGet(HttpExchange httpExchange) throws IOException
    {
    ...
    private String
    handlePost(HttpExchange httpExchange) throws IOException
    {
    ...
    //
    //            response = "Posted entry {" + language + ", " + year + "} (Previous year: " +
    //            oldYear + ")";
    //        } else {
    //            data.put(language, year);
    //

...
class Footer extends HBox {
    ...
    public Footer()
    {
        ...
        cancelButton.getStyleClass().addAll("action-button", "discard-button");
        ...
        regenButton.getStyleClass().addAll("action-button", "save-button");
    ...
    private Button
    createButton(String buttonLabel, String resourceName)
    {

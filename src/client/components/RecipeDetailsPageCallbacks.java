...
public class RecipeDetailsPageCallbacks {
    ...
    public RecipeDetailsPageCallbacks(Runnable onGoBackButtonClicked, Runnable onEditButtonClicked,
        Runnable onDeleteButtonClicked, Runnable onShareButtonClicked)
    {
    ...
    public Runnable
    getOnEditButtonClicked()
    {
        return onEditButtonClicked;
    }

    public Runnable
    getOnDeleteButtonClicked()
    {
        return onDeleteButtonClicked;
    }

    public Runnable
    getOnShareButtonClicked()
    {
